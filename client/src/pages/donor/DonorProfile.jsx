    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-700 mb-2">Loading Donor Profile</h2>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-white flex items-center justify-center">
        <div className="text-center bg-white rounded-2xl shadow-lg border border-red-100 p-8">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Donor Profile Error</h3>
          <p className="text-gray-600 mb-4">Could not load profile. Please ensure you are authenticated.</p>
          <button onClick={fetchProfile} className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg transition-colors">
            Retry Loading
          </button>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-red-100 p-6 mb-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800">{donor.fullName || "Donor Profile"}</h1>
                <p className="text-gray-600 mt-1 flex items-center gap-2">
                  <Droplets size={16} className="text-red-500" />
                  {donor.bloodGroup || "Blood Donor"} •<span className="font-mono text-sm">ID: {donor.donorId}</span>
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              {isEditing ? (
                <>
                  <button onClick={handleCancel} className="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg transition-colors border border-gray-300">
                    <X size={18} /> Cancel
                  </button>
                  <button
                    onClick={handleSave}
                ...
                <button onClick={() => setIsEditing(true)} className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-bold ${
                      donor.status === "active" ? "bg-green-100 text-green-700" : donor.status === "pending" ? "bg-yellow-100 text-yellow-700" : "bg-red-100 text-red-700"
                    }`}
                  >
                ...
                {donor.lastDonation && (
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-gray-800">{new Date(donor.lastDonation).toLocaleDateString()}</span>
                  </div>
                )}
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled={!isEditing}
                      className={`w-full px-4 py-3 rounded-xl border ${isEditing ? "border-gray-300 bg-white focus:ring-2 focus:ring-red-500 focus:border-red-500" : "bg-gray-50 border-gray-200"} ${
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {["street", "city", "state", "pincode"].map((field) => (
                    <div key={field} className={field === "street" ? "md:col-span-2" : ""}>
                      <label className="block text-sm font-medium text-gray-700 mb-2 capitalize">{field === "pincode" ? "PIN Code" : field}</label>
                      <input
