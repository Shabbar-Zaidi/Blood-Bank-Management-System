  ...
  const donationFacts = [
    {
      ...
      description: "A single blood donation can save up to 3 lives. Your one hour can give someone a lifetime.",
      stat: "3 Lives Saved",
    },
    {
      icon: RefreshCw,
      title: "Blood Regeneration",
      description: "Your body replaces the blood you donate within 24-48 hours. The red blood cells are completely replaced in 4-6 weeks.",
      stat: "48 Hours",
    },
    {
      icon: Users,
      title: "Constant Need",
      description: "Every 2 seconds, someone needs blood. Your regular donation ensures continuous supply for emergencies.",
      stat: "Every 2 Seconds",
    },
    {
      icon: AlertTriangle,
      title: "Short Shelf Life",
      description: "Red blood cells last only 42 days, platelets just 5 days. Regular donations are essential to maintain supply.",
  ...
  const eligibilityInfo = [
    {
      ...
      items: ["Age 17-75 (16 with parental consent)", "Weight at least 110 lbs (50 kg)", "Good general health", "No flu or cold symptoms"],
    },
    {
      icon: Stethoscope,
      title: "Health Benefits",
      items: ["Free health screening", "Burns 650 calories per donation", "Reduces risk of heart disease", "Stimulates blood cell production"],
    },
    {
      icon: Shield,
      title: "Safety First",
      items: ["Sterile, disposable equipment", "Trained medical staff", "Comfortable environment", "Post-donation care"],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-red-50 mt-10">
        ...
        <div className="container mx-auto px-4 py-20 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Connect <span className="bg-gradient-to-r from-red-200 to-red-300 bg-clip-text text-transparent">Blood Donors</span> with Those in Need
            </h1>

            <p className="text-lg md:text-xl text-red-100 mb-8 max-w-2xl mx-auto">
              Our advanced blood bank management system ensures efficient donation, storage, and distribution of blood products to save lives when every second counts.
            </p>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="text-center p-6 rounded-xl bg-red-50 hover:bg-red-100 transition-all duration-300">
                  ...
                  <div className="text-2xl md:text-3xl font-bold text-red-900 mb-1">{stat.value}</div>
                  <div className="text-red-700 text-sm font-medium">{stat.label}</div>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">Current Blood Needs</h2>
            <p className="text-lg text-slate-600">Real-time blood type requirements across our network. Your donation matters now more than ever.</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {bloodTypes.map((blood, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-4 text-center hover:shadow-xl transition-all duration-300">
                <div className={`text-2xl font-bold mb-2 ${blood.need === "Critical" ? "text-red-600" : blood.need === "High" ? "text-orange-500" : "text-green-500"}`}>{blood.type}</div>
                <div
                  className={`text-sm font-medium px-2 py-1 rounded-full ${
                    blood.need === "Critical" ? "bg-red-100 text-red-700" : blood.need === "High" ? "bg-orange-100 text-orange-700" : "bg-green-100 text-green-700"
                  }`}
                >
                  {blood.need} Need
                </div>
                <div className="text-xs text-slate-500 mt-2">{blood.donors} Donors</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">Why Your Blood Donation Matters</h2>
            <p className="text-lg text-slate-600">Every donation creates a ripple effect of hope and healing in our community.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {donationFacts.map((fact, index) => {
              ...
              return (
                <div key={index} className="bg-slate-50 rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-all duration-300 border-t-4 border-red-500">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-red-100 flex items-center justify-center">
                    <Icon className="w-8 h-8 text-red-600" />
                  </div>
                  <h3 className="text-lg font-semibold mb-3 text-slate-800">{fact.title}</h3>
                  <p className="text-slate-600 text-sm mb-4">{fact.description}</p>
                  <div className="text-red-600 font-bold text-lg">{fact.stat}</div>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-red-600 to-red-800 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Who Needs Your Blood?</h2>
            <p className="text-lg text-red-100">Your donation directly impacts patients in critical situations</p>
          </div>
            ...
            {emergencyNeeds.map((need, index) => {
              ...
              return (
                <div key={index} className="bg-white/10 rounded-2xl p-6 text-center backdrop-blur-sm hover:bg-white/15 transition-all duration-300">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-white">{need.type}</h3>
          ...
          <div className="text-center mt-12">
            <div className="bg-white/10 rounded-2xl p-6 max-w-2xl mx-auto backdrop-blur-sm">
              ...
              <p className="text-red-100">Your single donation can make all the difference.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">How It Works</h2>
            <p className="text-lg text-slate-600">Simple steps to become a life-saver. Join thousands of donors making a difference.</p>
          </div>
              ...
              return (
                <div key={index} className="text-center group">
                  <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 border-t-4 border-red-500 group-hover:transform group-hover:-translate-y-2">
                    <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-red-100 flex items-center justify-center text-red-600 font-bold">{step.step}</div>
                    {Icon && (
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">Donor Eligibility & Benefits</h2>
            <p className="text-lg text-slate-600">Safe, simple, and rewarding - discover the benefits of blood donation</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {eligibilityInfo.map((info, index) => {
              ...
              return (
                <div key={index} className="bg-slate-50 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
      ...
      <section id="about" className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">Why Choose Our Blood Bank System?</h2>
            <p className="text-lg text-slate-600">We provide a comprehensive platform that connects donors, hospitals, and blood banks to ensure efficient blood collection and distribution.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-all duration-300 border-t-4 border-red-500">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-red-100 flex items-center justify-center">
                    <Icon className="w-8 h-8 text-red-600" />
                  </div>
